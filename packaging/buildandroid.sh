...
./build.py --package "com.mortalpowers.android.hexslayer" --name "HexSLayer" --version "$VERSION" --numeric-version 12 --private ../tmp --permission INTERNET --icon /super/workspace/HexSLayer/gameicon.png ${TYPE}
rm -r ../tmp
